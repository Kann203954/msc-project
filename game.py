...
class SGame:
    ...
    def __init__(self,
        ...
        transition_matrices:  list of array-like, one for each from_state: transition_matrices[s][A,ns]
        ...
        # build big transition matrix [s,A,ns] from list of small transition matrices [A,ns] for each s
        ...
        # 函数用的QL矩阵需要对齐，为输出美观生成一个不补全对齐的Q表
